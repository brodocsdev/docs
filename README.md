...
This is MVP of site generator from markdown files to easily build internal or public docs portal from single git monorepo or from multiple micro (and nano 😎) repos. No account is needed to test it, just send [HTTP POST](/Quick%20start.md) to get site like this.

> **💡 Note:** Source markdown files for this site are committed  on [github docs repo](https://github.com/brodocsdev/docs).
> Check some more complex site [example](https://brodocs.io/975abcb773619a787f7/pumlhitchhiker/README.html) with [PlantUML](https://plantuml.com) diagrams.
